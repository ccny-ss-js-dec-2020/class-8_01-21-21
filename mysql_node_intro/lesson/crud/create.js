...
*/
databaseConnection.query("INSERT INTO users (first_name, last_name, email, username, password) VALUES ('Jimmy', 'Bags', 'joeybags@bags.com', 'joeybags', 'password')", function(err, result) {
	if(err){
